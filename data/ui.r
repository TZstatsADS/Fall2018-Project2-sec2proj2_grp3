            ...
            navbarPage(p(class="h","Plan-a-Restaurant"),id = "inTabset", 
                       ...
                       tabPanel("Find-it!", icon = icon("search"),  fluidPage(
                         fluidRow(
                           ...
                           column(2,
                                  selectInput("check2_class", "Residence Class Targets:",c(" " = "", list("Upper", "Middle", "Working", "Lower")), 
                                              multiple=TRUE)),
                           column(2,
                                  selectInput("check2_age", "Residence Age Targets :", c(" " = "", list("<5", "5-14", "15-24", "25-34", "35-44", "45-54", "55-64", "65+")),
                                              multiple=TRUE))
                         ),
                         ...
                         fluidRow(
                           ...
                           column(3,
                                  selectInput("check2_market","Marketw:", c(" " = "", list("1","2","3")))),
